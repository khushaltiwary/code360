          ...
          while (pollCount < maxPolls) {
            ...
            try {
              ...
              if (statusData.status === "completed") {
                ...
                if (statusData.documentation_urls) {
                  console.log("3. Documentation URLs:");
                  Object.entries(statusData.documentation_urls).forEach(([file_path, urls]) => {
                    console.log(`File: ${file_path}`);
                    console.log(`Markdown URL: ${urls.markdown_url}`);
                    console.log(`DOCX URL: ${urls.docx_url || "N/A"}`);
                  });
...
export const selectDocumentationStatus = (state) => state.githubRepo.documentationStatus;
export const selectDocumentationUrls = (state) => state.githubRepo.documentationUrls;
